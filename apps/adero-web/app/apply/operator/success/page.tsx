...
export default function OperatorSuccessPage() {
  return (
    <section
    ...
    >
      <div className="mx-auto max-w-lg text-center">
        ...
        <p className="text-base leading-relaxed mb-10" style={{ color: "#64748b" }}>
          We have received your operator application and will review it personally.
        ...
        >
          ...
          <ol className="space-y-2">
            {[
              ...
              "We reach out to discuss your availability and the types of jobs in your market.",
              "Approved operators begin receiving overflow bookings from Adero partner companies.",
            ].map((step, i) => (
