      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {[
          ...
          },
          {
            ...
            value: aderoUser.companyProfileId ? "Linked" : "Unlinked",
            color: aderoUser.companyProfileId ? "#4ade80" : "#f87171",
          },
      ...
      {requests.length === 0 ? (
        ...
        >
          ...
          <p className="mt-1 text-xs" style={{ color: "#334155" }}>
            Submit a transportation request to get started.
          </p>
          <Link
            href="/app/company/request/new"
