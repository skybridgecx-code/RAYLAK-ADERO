...
<body style="margin:0;padding:0;background:#f1f5f9;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">
  <div style="max-width:560px;margin:40px auto;background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
    ...
    <div style="background:#0c1425;padding:36px 40px 28px;">
      ...
      <h1 style="margin:0;color:#f1f5f9;font-size:22px;font-weight:300;letter-spacing:-0.3px;">Your Member Portal</h1>
    </div>
    ...
    <div style="padding:36px 40px;">
      ...
      <div style="margin:0 0 28px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:20px 24px;">
        <p style="margin:0 0 12px;color:#94a3b8;font-size:11px;letter-spacing:2px;text-transform:uppercase;font-weight:600;">
          Your Portal Link
        </p>
        <a
          href="${portalUrl}"
          style="display:inline-block;background:#6366f1;color:#ffffff;text-decoration:none;padding:11px 22px;border-radius:7px;font-size:14px;font-weight:500;letter-spacing:0.1px;"
        >
          Open Member Portal →
        </a>
        <p style="margin:14px 0 0;word-break:break-all;color:#94a3b8;font-size:11px;">
          ${portalUrl}
        </p>
      </div>

      <p style="margin:0;color:#94a3b8;font-size:12px;line-height:1.6;">
        This link is private — do not share it. If you believe it has been compromised, contact
        your Adero representative to request a new link. Do not reply to this email.
      </p>
    </div>

    <div style="background:#0c1425;padding:20px 40px;text-align:center;">
      <p style="margin:0;color:#334155;font-size:11px;">
        Adero Network · Member services
      </p>
    </div>
  </div>
</body>
